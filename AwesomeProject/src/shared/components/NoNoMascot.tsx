...
export type NoNoMood = 'idle' | 'thinking' | 'success' | 'error' | 'confirm';
...
export const NoNoMascot: React.FC<NoNoMascotProps> = ({
  ...
  return (
    <View
      style={[
        styles.body,
        {width: size, height, borderRadius: size * 0.48},
        attention && styles.attention,
      ]}>
      <View style={[styles.ear, {left: -3, height: size * 0.29, top: height * 0.42}]} />
      <View style={[styles.ear, {right: -3, height: size * 0.29, top: height * 0.42}]} />
      <View
        style={[
          styles.visor,
          {width: size * 0.66, height: height * 0.42, borderRadius: size * 0.22},
        ]}>
        <View
          style={[
            styles.eye,
