...
export const PageLayout: React.FC<PageLayoutProps> = ({
  ...
  return (
    <View style={[styles.container, {backgroundColor}]}>
      {safeArea && Platform.OS === 'ios' && <StatusBar barStyle="dark-content" />}
      {Platform.OS === 'android' && (
      ...
      {showBackButton ? (
        <View style={styles.subpageHeader}>
          <TouchableOpacity style={styles.roundButton} onPress={handleBackPress} activeOpacity={0.8}>
            <AppIcon name={IconNames.arrowLeft} size={18} color={COLORS.text.primary} />
          </TouchableOpacity>
