...
export const NoNoSettingsView: React.FC<NoNoSettingsViewProps> = ({
  adbFallbackEnabled,
  ...
  onOpenSearchEditor,
  onSearchDraftChange,
  onSaveSearchPosition,
  onCancelSearchPosition,
  ...
  return (
    <PageLayout
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <SectionHeading title="执行偏好" hint="本机设置" />
        ...
        <View style={styles.settingRow}>
          ...
          <Switch
            accessibilityLabel="ADB 兜底运行"
            value={adbFallbackEnabled}
            onValueChange={onToggleAdb}
            trackColor={{false: '#d8d7df', true: COLORS.violet}}
            thumbColor="#ffffff"
          />
        </View>
        <TouchableOpacity
          ...
          onPress={onOpenSearchEditor}
          accessibilityRole="button"
          accessibilityLabel="编辑手机应用搜索框位置">
          <View style={styles.settingInfo}>
        ...
        <SectionHeading title="权限中心" hint="跳转系统设置" />
        <TouchableOpacity style={styles.settingRow} onPress={onOpenOverlaySettings}>
          <View style={styles.settingInfo}>
        ...
        <TouchableOpacity style={styles.settingRow} onPress={onOpenNotificationSettings}>
          <View style={styles.settingInfo}>
        ...
        <TouchableOpacity style={styles.settingRow} onPress={onOpenAccessibilitySettings}>
          <View style={styles.settingInfo}>
        ...
        <SectionHeading title="支持" hint="本地诊断" />
        <TouchableOpacity
          style={styles.linkRow}
          onPress={onOpenDebugLogs}
          accessibilityRole="button"
        ...
        <Modal
          ...
          transparent
          animationType="fade"
          onRequestClose={onCancelSearchPosition}>
          <TouchableOpacity
            style={styles.modalOverlay}
            activeOpacity={1}
            onPress={onCancelSearchPosition}>
